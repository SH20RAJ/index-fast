  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "fixed z-50 flex h-auto flex-col border border-border bg-background text-foreground",
        ...
        {...props}
      >
        <div className="mx-auto mt-3 hidden h-1 w-10 shrink-0 rounded-full bg-border data-[vaul-drawer-direction=bottom]:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col gap-1 p-5 pb-3 data-[vaul-drawer-direction=bottom]:text-center data-[vaul-drawer-direction=top]:text-center",
        className
      )}
      {...props}
    />

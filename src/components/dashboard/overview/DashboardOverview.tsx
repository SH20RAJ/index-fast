...
export default function DashboardOverview({ data }: DashboardOverviewProps) {
  ...
  return (
    <div className="space-y-6 md:space-y-10">
      <section className="relative overflow-hidden rounded-[32px] border border-black/5 bg-white shadow-xl shadow-black/5 dark:border-white/5 dark:bg-zinc-900/50 dark:shadow-none">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl font-light tracking-tight text-zinc-900 sm:text-5xl dark:text-zinc-100">
                Your indexing <br />
                <span className="italic text-rose-500">momentum.</span>
              </h1>
              <p className="max-w-md text-base text-zinc-500 dark:text-zinc-400 font-light leading-relaxed">
                Effortless tracking for your websites and submission health. 
              ...
              {insightRows.map((item, index) => {
                ...
                return (
                  <div key={item.label} className="group space-y-2">
                    ...
                    <p className="text-lg font-medium text-zinc-900 dark:text-zinc-100">{insightValues[index]}</p>
                  </div>
                );
              })}
            </div>
      ...
      <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <Card className="border-black/5 bg-white dark:border-white/5 dark:bg-zinc-900/40">
          <CardHeader className="flex flex-row items-center justify-between border-b border-zinc-50 px-6 py-4 dark:border-white/5">
            <CardTitle className="text-sm font-bold uppercase tracking-widest text-zinc-400">Recent Pulse</CardTitle>
          ...
          <CardContent className="p-0">
            {data.recentSubmissions.length === 0 ? (
              <div className="p-12 text-center">
                <CircleCheck className="mx-auto h-8 w-8 text-zinc-200" />
        ...
        <Card className="border-black/5 bg-white dark:border-white/5 dark:bg-zinc-900/40">
          <CardHeader className="border-b border-zinc-50 px-6 py-4 dark:border-white/5">
            <CardTitle className="text-sm font-bold uppercase tracking-widest text-zinc-400">Limits</CardTitle>
          </CardHeader>

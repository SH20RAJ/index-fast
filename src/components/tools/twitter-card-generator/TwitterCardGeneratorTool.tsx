...
export default function TwitterCardGeneratorTool() {
  ...
  const generatedCode = `<!-- Twitter Card Tags -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="${handle || "@username"}">
<meta name="twitter:title" content="${title || "Page Title"}">
<meta name="twitter:description" content="${description || "Page description goes here."}">
<meta name="twitter:image" content="${image || "https://example.com/image.png"}">`;

  const handleCopy = () => {
    navigator.clipboard.writeText(generatedCode);
    setCopied(true);
    toast.success("Twitter Tags copied to clipboard");
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-5">
              <div className="space-y-3">
                <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground px-1">Twitter Handle</Label>
              ...
              <div className="space-y-3">
                <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground px-1">Card Image URL</Label>
                <div className="relative">
                  <Input
                    value={image}
                ...
                <div className="rounded-2xl bg-background border border-border/50 shadow-sm overflow-hidden flex flex-col max-w-[400px]">
                  ...
                  <div className="p-4 space-y-1.5 border-t border-border/40">
                    <h3 className="text-sm font-bold text-foreground line-clamp-1">
                      {title || "Example Twitter Card Title"}
                    </h3>
                    <p className="text-xs text-muted-foreground leading-relaxed line-clamp-2">
                      {description || "This is how your description will appear in a Twitter/X card. Make it concise and engaging."}
                    </p>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between px-1">
                  <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground flex items-center gap-1.5">
                    <Code className="h-3 w-3" /> Meta Tags
                  </Label>
                  <Button 
                    variant="ghost" 
                    size="sm" 
                ...
                <pre className="p-4 rounded-2xl bg-zinc-950 text-zinc-400 font-mono text-[10px] leading-relaxed overflow-x-auto scrollbar-hide border border-white/5 h-[130px]">
                  {generatedCode}
                </pre>
              </div>
            </div>
          ...
          <div className="p-6 rounded-[2rem] bg-zinc-950 text-white relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="space-y-2 text-center md:text-left">
                <h4 className="text-lg font-bold tracking-tight">Optimize for every platform</h4>
                <p className="text-sm text-zinc-400 max-w-md">
                  IndexFast Pro ensures your site looks perfect on X, Facebook, Slack, and Discord by generating optimized assets automatically.
                </p>
              </div>

...
import IndexabilityCheckerTool from "./IndexabilityCheckerTool";

export default function IndexabilityCheckerPageContent() {
  const slug = "indexability-checker";

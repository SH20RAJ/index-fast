...
import KeywordCompetitionCheckerTool from "./KeywordCompetitionCheckerTool";

export default function KeywordCompetitionCheckerPageContent() {
  const slug = "keyword-competition-checker";

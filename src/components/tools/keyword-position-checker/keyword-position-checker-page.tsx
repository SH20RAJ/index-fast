...
import KeywordPositionCheckerTool from "./KeywordPositionCheckerTool";

export default function KeywordPositionCheckerPageContent() {
  const slug = "keyword-position-checker";

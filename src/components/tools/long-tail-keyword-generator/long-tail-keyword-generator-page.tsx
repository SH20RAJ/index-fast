...
import LongTailKeywordGeneratorTool from "./LongTailKeywordGeneratorTool";

export default function LongTailKeywordGeneratorPageContent() {
  const slug = "long-tail-keyword-generator";

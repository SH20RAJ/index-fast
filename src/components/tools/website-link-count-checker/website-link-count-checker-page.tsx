...
import WebsiteLinkCountCheckerTool from "./WebsiteLinkCountCheckerTool";

export default function WebsiteLinkCountCheckerPageContent() {
  const slug = "website-link-count-checker";

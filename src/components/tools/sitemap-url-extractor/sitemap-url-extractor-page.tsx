...
import SitemapUrlExtractorTool from "./SitemapUrlExtractorTool";

export default function SitemapUrlExtractorPageContent() {
  const slug = "sitemap-url-extractor";

...
import DomainHostingCheckerTool from "./DomainHostingCheckerTool";

export default function DomainHostingCheckerPageContent() {
  const slug = "domain-hosting-checker";

...
import ServerStatusCheckerTool from "./ServerStatusCheckerTool";

export default function ServerStatusCheckerPageContent() {
  const slug = "server-status-checker";

...
import DomainSpamScoreCheckerTool from "./DomainSpamScoreCheckerTool";

export default function DomainSpamScoreCheckerPageContent() {
  const slug = "domain-spam-score-checker";

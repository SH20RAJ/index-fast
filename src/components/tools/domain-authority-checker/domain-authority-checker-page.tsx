...
import DomainAuthorityCheckerTool from "./DomainAuthorityCheckerTool";

export default function DomainAuthorityCheckerPageContent() {
  const slug = "domain-authority-checker";

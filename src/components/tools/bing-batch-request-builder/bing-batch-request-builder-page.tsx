...
import BingBatchRequestBuilderTool from "./BingBatchRequestBuilderTool";

export default function BingBatchRequestBuilderPageContent() {
  const slug = "bing-batch-request-builder";

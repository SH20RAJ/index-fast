...
import IndexnowKeyValidatorTool from "./IndexnowKeyValidatorTool";

export default function IndexnowKeyValidatorPageContent() {
  const slug = "indexnow-key-validator";

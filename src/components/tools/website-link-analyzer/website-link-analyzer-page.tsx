...
import WebsiteLinkAnalyzerTool from "./WebsiteLinkAnalyzerTool";

export default function WebsiteLinkAnalyzerPageContent() {
  const slug = "website-link-analyzer";

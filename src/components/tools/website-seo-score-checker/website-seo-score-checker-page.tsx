...
import WebsiteSeoScoreCheckerTool from "./WebsiteSeoScoreCheckerTool";

export default function WebsiteSeoScoreCheckerPageContent() {
  const slug = "website-seo-score-checker";

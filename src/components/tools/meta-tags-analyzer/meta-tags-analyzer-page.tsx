...
import MetaTagsAnalyzerTool from "./MetaTagsAnalyzerTool";

export default function MetaTagsAnalyzerPageContent() {
  const slug = "meta-tags-analyzer";

...
import KeywordDifficultyCheckerTool from "./KeywordDifficultyCheckerTool";

export default function KeywordDifficultyCheckerPageContent() {
  const slug = "keyword-difficulty-checker";

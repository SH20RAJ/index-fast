...
import FreeSearchEngineSubmissionTool from "./FreeSearchEngineSubmissionTool";

export default function FreeSearchEngineSubmissionPageContent() {
  const slug = "free-search-engine-submission";
    ...
    <>
      ...
      >
        <div className="mt-10 mb-16">
          <FreeSearchEngineSubmissionTool />
        </div>
      </ToolPageShell>
    </>
  );

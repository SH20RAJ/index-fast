...
import SitemapHealthCheckerTool from "./SitemapHealthCheckerTool";

export default function SitemapHealthCheckerPageContent() {
  const slug = "sitemap-health-checker";

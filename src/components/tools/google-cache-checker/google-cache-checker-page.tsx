...
import GoogleCacheCheckerTool from "./GoogleCacheCheckerTool";

export default function GoogleCacheCheckerPageContent() {
  const slug = "google-cache-checker";

...
export const SEO_TOOLS: ToolDefinition[] = [
  ...
  {
    slug: "submitexpress-bulk-submitter",
    title: "SubmitExpress Bulk Submitter",
    categoryId: "indexing-crawl",
    primaryKeyword: "free submitexpress bulk submitter",
    description: "Bulk submit URLs and sitemaps to multiple search engines via the SubmitExpress free submission service.",
    intentKeywords: ["free submitexpress bulk submitter", "bulk search engine submission", "submit sitemap to all engines"],
  },
  {
    slug: "free-search-engine-submission",
    title: "Free Search Engine Submission",
    categoryId: "indexing-crawl",
    primaryKeyword: "free search engine submission tool",
    description: "Submit your website to over 140 major search engines simultaneously to speed up discovery.",
    intentKeywords: ["free search engine submission tool", "submit website to all search engines", "bulk search engine submittal"],
  },
  {
...
export const FREE_TOOLS: FreeTool[] = [
  ...
  {
    id: "brave-search-submit",
    title: "Brave Search Submission",
    description: "Submit your website directly to the Brave Search index for faster discovery and crawling. A privacy-focused search engine with growing market share.",
    url: "https://search.brave.com/submit-url",
    categoryId: "ping-indexing",
    tags: ["brave", "search submission", "indexing", "url submit", "privacy search"],
    tier: "free",
    canEmbed: false,
  },
  {
    id: "submitexpress-submit",
    title: "SubmitExpress Website Submission",
    description: "Free website submission tool to notify multiple search engines and directories at once about your new or updated site.",
    url: "https://www.submitexpress.com/free-tools/free-website-submission/",
    categoryId: "ping-indexing",
    tags: ["submitexpress", "search engines", "directory submission", "free submit", "indexing"],
    tier: "free",
    canEmbed: false,
  },
  {
    id: "free-search-engine-submission",
    title: "Free Search Engine Submission",
    description: "Submit your website to over 140 search engines including Google, Bing, and Yahoo at once through LowestHosting's free tool.",
    url: "https://www.lowesthosting.com/sesubmit/",
    categoryId: "ping-indexing",
    tags: ["search engine submission", "lowesthosting", "bulk submit", "google submit", "bing submit", "yahoo submit"],
    tier: "free",
    canEmbed: false,
  },
  {
